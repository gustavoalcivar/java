 ...
 * @author gustavo
 */
public class Euler extends javax.swing.JFrame {
    ...
    int elemento=0,n;
    double x0,y0, _x, h, valorFuncion;
    ...
    private void initComponents() {
        ...
        getContentPane().add(textX0, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 20, 93, -1));

        jLabel2.setText("y0:");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 49, -1, -1));
        getContentPane().add(textY0, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 50, 93, -1));
        ...
        getContentPane().add(textN, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 80, 93, -1));
        ...
        getContentPane().add(botonSen, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 110, -1, -1));
        ...
        getContentPane().add(botonCos, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 110, -1, -1));
        ...
        getContentPane().add(botonTan, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 140, -1, -1));
        ...
        getContentPane().add(textResultado, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 430, 540, -1));
        ...
        getContentPane().add(botonX, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 110, 44, -1));
        ...
        getContentPane().add(botonAbs, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 140, -1, -1));
        ...
        getContentPane().add(botonASen, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 110, -1, -1));
        ...
        getContentPane().add(botonACos, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 110, -1, -1));
        ...
        getContentPane().add(botonATan, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 140, -1, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 470, -1, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 470, -1, -1));
        ...
        getContentPane().add(botonY, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 110, -1, -1));

        jLabel6.setText("Punto a evaluar:");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 20, -1, -1));
        getContentPane().add(text_x, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 20, 93, -1));
...
//        try{
            ...
            if(n>0){
                 for(int i = 0; i < n; i++) {
                     ValorEuler f = new ValorEuler();
                     f.evaluarFuncion(funcion, String.valueOf(x0), String.valueOf(y0));
                     valorFuncion = Double.parseDouble(f.Resultado());
                   
                     valorFuncion = h*valorFuncion+y0;
                     y0 = valorFuncion;
                     x0 += h;
                 }
                 
                 textResultado.setText(String.valueOf(y0));
...
private void botonATanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonATanActionPerformed
    ...
    private boolean datosValidos() {
        if(textX0.getText().equals("")||textY0.getText().equals("")
