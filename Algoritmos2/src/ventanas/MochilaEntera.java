...
public class MochilaEntera extends javax.swing.JFrame {
    
    private double peso[], beneficio[], pmaximo, solucion[];

    public MochilaEntera() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("MOCHILA ENTERA");

        jLabel1.setFont(new java.awt.Font("Dialog", 1, 18));
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("MOCHILA ENTERA");
...
Metodos.validarTextArea(textValor);
        try {
            ...
            if(peso.length == beneficio.length) {
                ...
                solucion = algoritmos.Algoritmos.mochilaEntera(elementos, elementos.length, pmaximo, solucion);
